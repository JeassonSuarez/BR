...
public class ValoresCoordenadas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        deslizamientoHorizontal.setMaximum(650);
        deslizamientoHorizontal.setValue(0);
        deslizamientoHorizontal.setOpaque(false);
        ...
        jSangulo2.setValue(5);
        jSangulo2.setOpaque(false);
        ...
        jSangulo4.setValue(5);
        jSangulo4.setOpaque(false);
        ...
        jSangulo3.setValue(5);
        jSangulo3.setOpaque(false);
        ...
        Title_X.setAlignment(java.awt.Label.RIGHT);
        Title_X.setMinimumSize(new java.awt.Dimension(54, 14));
        Title_X.setText("X");

        Title_Z.setAlignment(java.awt.Label.RIGHT);
        Title_Z.setText("Z");

        Title_Y.setAlignment(java.awt.Label.RIGHT);
        Title_Y.setText("Y");

        x1.setAlignment(java.awt.Label.RIGHT);
        x1.setText("0");

        x2.setAlignment(java.awt.Label.RIGHT);
        x2.setText("0");

        x3.setAlignment(java.awt.Label.RIGHT);
        x3.setText("0");

        x4.setAlignment(java.awt.Label.RIGHT);
        x4.setText("0");

        y1.setAlignment(java.awt.Label.RIGHT);
        y1.setText("0");

        y2.setAlignment(java.awt.Label.RIGHT);
        y2.setText("0");

        y3.setAlignment(java.awt.Label.RIGHT);
        y3.setText("0");

        y4.setAlignment(java.awt.Label.RIGHT);
        y4.setText("0");

        z1.setAlignment(java.awt.Label.RIGHT);
        z1.setText("0");

        z2.setAlignment(java.awt.Label.RIGHT);
        z2.setText("0");

        z3.setAlignment(java.awt.Label.RIGHT);
        z3.setText("0");

        z4.setAlignment(java.awt.Label.RIGHT);
        z4.setText("0");
    ...
    class FondoPanel extends JPanel{
        ...
        public void paint(Graphics g) {
            ...
            fondo=new ImageIcon(getClass().getResource("/imagenes/fondo_pantalla.png")).getImage(); 
